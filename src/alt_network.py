...
class Network:
    def __init__(self, memory, population:str, num_agents:int, max_context_size:int):
    ...
    def _init_agents(self):
        start_time = time.time()
        agents = [Agent(self.memory, name, identity, self.client) 
